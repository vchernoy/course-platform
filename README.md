...
| [docs/auth-and-visibility.md](docs/auth-and-visibility.md) | Clerk, `students.yaml`, `admins.yaml` (offering + optional site scopes), middleware, `/p`, `/s`, `/offerings`, admin routes, security boundaries |
